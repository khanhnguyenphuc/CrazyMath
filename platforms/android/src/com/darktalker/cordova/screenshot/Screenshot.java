...
public class Screenshot extends CordovaPlugin {
	...
	private Bitmap getBitmap() {
		...
		// } else 
		{
			...
			// int contentViewTop = cordova.getActivity().getWindow().getDecorView().getTop();  skip status bar in screenshot 
  	// 		Storage.shareBitmapInfo = Bitmap.createBitmap(bitmap, 0, contentViewTop, bitmap.getWidth(), bitmap.getHeight() - contentViewTop, null, true);
